<?php
if ($slides = carbon_get_post_meta(get_the_ID(), 'crb_fdb')) {
?>
    <section class="feedback-section">
        <div class="fixed-container">
            <?php
            if ($block_head = carbon_get_post_meta(get_the_ID(), 'crb_fdb_head')) {
                echo ' <h2 class="title">' . $block_head . '</h2>';
            }

            if ($block_desc = carbon_get_post_meta(get_the_ID(), 'crb_fdb_desc')) {
                echo ' <p class="block_description">' . $block_desc . '</p>';
            }
            ?>
            <div class="swiper feedback-slider">
                <div class="slider-controls">
                    <div class="fdb-slider__button-prev">
                    ...
                    <div class="fdb-slider__button-next">
                ...
                <div class="swiper-wrapper">
                    ...
                    foreach ($slides as $slide) {
                        $slide_img = wp_get_attachment_image_url($slide['crb_fdb_item'], 'full');
                    ?>
                    <?php //print_r($slide_img); ?>
                        <a href="<?php echo $slide_img ?>" data-fancybox="gallery" class="swiper-slide feedback-slider__slide">
                            <img src="<?php echo $slide_img ?>" alt="Отзывы ЛИКС клининг" />
                        </a>
                    <?php
                    }
                    ?>
