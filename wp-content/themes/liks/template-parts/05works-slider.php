...
?>
    <section class="works-section">
        <div class="fixed-container">
            ...
            if ($block_desc = carbon_get_post_meta(get_the_ID(), 'crb_desc')) {
                echo ' <p class="block_description">' . $block_desc . '</p>';
            }
            ?>
            <div class="swiper works-slider">
                <div class="slider-controls">
                    <div class="works-slider__button-prev">
                    ...
                    <div class="works-slider__button-next">
                ...
                <div class="swiper-wrapper">
                    ...
                    foreach ($slides as $slide) {
                        $slide_img = wp_get_attachment_image_url($slide['crb_work_item'], 'full');
                    ?>
                        <a href="<?php echo $slide_img ?>" data-fancybox="gallery" class="swiper-slide works-slider__slide">
                            <img src="<?php echo $slide_img ?>" alt="Фото наших работ" />
                        </a>
                    <?php
                    }
                    ?>
